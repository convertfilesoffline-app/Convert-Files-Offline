...
To install the app on Windows, you can purchase prebuilt executables from the [official website](https://convertfilesoffline.com/).
Any purchase supports ongoing development and helps maintain the [free demo](https://convertfilesoffline.com).
